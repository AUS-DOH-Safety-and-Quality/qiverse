...
The `qiverse.powerbi` package stores a function that download PowerBI dataflow tables using the REST API, using the Azure Access Token to authenticate to the PowerBI online service. An example set of code for `download_dataflow_table` is below:
