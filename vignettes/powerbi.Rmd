...
data_calendar <- download_dataflow_table(
  workspace_name = "DOH - Reference Data", #can these examples be made generic like in the Azure vignette? 
...
data_lbw <- download_dataset_table_rest(
  workspace_name = "DOH - Reference Data", #these examples should be made generic as well
