...
-   `site_url` - This is the url when first accessing the SharePointteam via your web browser (Home page)
...
The functions available in `qiverse.azure` serve as easy-to-use wrappers of the `Microsoft365R` package, to conduct key functions such as downloading and uploading SharePoint files, and downloading SharePoint lists. More functionality is available directly in the package such as create, modify and delete lists, and managing SharePoint sites.
