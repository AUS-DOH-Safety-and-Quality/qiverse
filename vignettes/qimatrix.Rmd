...
-   `parent_group_name` - A vector of parent group names which are to be displayed in the tooltip. These are the major categories for the groups, i.e. HSP names. #make this more generic again? As in: i.e. Local health network or organisation names.
