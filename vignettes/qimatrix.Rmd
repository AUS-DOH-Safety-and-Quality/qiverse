...
-   `parent_group_name` - A vector of parent group names which are to be displayed in the tooltip. These are the major categories for the groups, i.e. HSP names.
-   `indicator_group` - A vector used for indicator grouping i.e. QSG Theme.
